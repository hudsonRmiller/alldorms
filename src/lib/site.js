...
export const SCHOOL_ALIASES = {
  ...
  fordham: ['Fordham University', 'Fordham', 'Rams', 'Fordham Rams', 'Rose Hill', 'The Bronx', 'Bronx', 'Jesuit', 'Ram Van', 'Arthur Avenue', 'Lincoln Center'],
  gwu: ['George Washington University', 'George Washington', 'GW', 'GWU', 'Revolutionaries', 'Colonials', 'Foggy Bottom', 'Mount Vernon', 'The Vern', 'Washington DC', 'Thurston'],
  american: ['American University', 'American', 'AU', 'Eagles', 'AU Eagles', 'Washington DC', 'Tenleytown', 'Spring Valley', 'School of International Service', 'SIS'],
  smu: ['Southern Methodist University', 'SMU', 'Mustangs', 'Pony Up', 'Dallas', 'University Park', 'Park Cities', 'Residential Commons', 'The Boulevard', 'Peruna'],
  tcu: ['Texas Christian University', 'TCU', 'Horned Frogs', 'Frogs', 'Go Frogs', 'Riff Ram', 'Fort Worth', 'Worth Hills', 'Frogs First', 'SuperFrog'],
  pepperdine: ['Pepperdine University', 'Pepperdine', 'Waves', 'Pepperdine Waves', 'Malibu', 'Seaver', 'Seaver College', 'Willie the Wave', 'PCH'],
  denver: ['University of Denver', 'Denver', 'DU', 'Pioneers', 'DU Pioneers', 'Mile High', 'University Park', 'Dimond', 'J-Mac', 'Boone'],
